...
void actualise_stat_building(struct building *b)
{
	...
	else if (strcmp(b->skin, "131") == 0)
	{
		if (b->angle =='a')
		{
			...
			sortedInsert(new);
			new = malloc(sizeof(struct to_disp));
			new->img = img->s->ship1_250cm_wood_triangle;
			new->x = b->x+2;
			new->y = b->y+3;
			new->id = b->id;
			new->floor = 0;
			...
			sortedInsert(new);
			new = malloc(sizeof(struct to_disp));
			new->img = img->s->ship1_flat_wood_down_triangle;
			new->x = b->x-2;
			new->y = b->y-4;
			new->id = b->id;
			new->floor = 0;
			...
			sortedInsert(new);
			new = malloc(sizeof(struct to_disp));
			new->img = img->s->ship1_flat_wood_left_triangle;
			new->x = b->x+2;
			new->y = b->y-4;
			new->id = b->id;
			new->floor = 0;
			...
			sortedInsert(new);
			new = malloc(sizeof(struct to_disp));
			new->img = img->s->ship1_flat_wood_right_triangle;
			new->x = b->x-1;
			new->y = b->y+4;
			new->id = b->id;
			new->floor = 0;

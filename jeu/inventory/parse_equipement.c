...
void actualise_stat_building(struct building *b)
{
	...
	else if (strcmp(b->skin, "131") == 0)
	{
		...
		else
		{
			if (b->angle =='a')
			{
				insert(b->x-2, b->y-3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y-3, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x, b->y-3, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+1, b->y-3, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+2, b->y-3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y-2, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+1, b->y-2, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+2, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y-1, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+1, b->y-1, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+2, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+1, b->y, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood);
				insert(b->x+2, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-0, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y+3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y+3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y+3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y-4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y-4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y-4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y+4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y+3, b->id, 0, 868, 450, NULL, b, img->s->ship1_250cm_wood_triangle);
				insert(b->x+1, b->y+4, b->id, 0, 868, 450, NULL, b, img->s->ship1_250cm_wood_triangle);
				insert(b->x-2, b->y-4, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood_down_triangle);
				insert(b->x+2, b->y-4, b->id, 0, 851, 372, NULL, b, img->s->ship1_flat_wood_left_triangle);
				insert(b->x-1, b->y+4, b->id, 0, 885, 372, NULL, b, img->s->ship1_flat_wood_right_triangle);
				insert(b->x-2, b->y+3, b->id, 0, 885, 372, NULL, b, img->s->ship1_flat_wood_right_triangle);
				insert(b->x, b->y-2, b->id, 0, 880, 345, NULL, b, img->s->ship1_bigSail);
				insert(b->x, b->y+3, b->id, 0, 880, 345, NULL, b, img->s->ship1_bigSail);
			}
			...
			else if (b->angle =='b')
			{
				...
				insert(b->x+2, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				...
				insert(b->x+1, b->y+3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y+3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y+4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y+4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y+4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y-3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				...
				insert(b->x-1, b->y-3, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y-4, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y+4, b->id, 0, 868, 450, NULL, b, img->s->ship1_250cm_wood_triangle);
				insert(b->x-1, b->y-4, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood_down_triangle);
				insert(b->x+2, b->y-3, b->id, 0, 851, 372, NULL, b, img->s->ship1_flat_wood_left_triangle);
				insert(b->x+1, b->y-4, b->id, 0, 851, 372, NULL, b, img->s->ship1_flat_wood_left_triangle);
				insert(b->x-2, b->y+4, b->id, 0, 885, 372, NULL, b, img->s->ship1_flat_wood_right_triangle);
				insert(b->x-2, b->y-3, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood_down_triangle);
				insert(b->x, b->y+4, b->id, 0, 880, 345, NULL, b, img->s->ship1_bigSail);
				insert(b->x, b->y-1, b->id, 0, 880, 345, NULL, b, img->s->ship1_bigSail);
			}
			else if (b->angle =='e')
			{
				insert(b->x-3, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-3, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+1, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-3, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-3, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-2, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-1, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				...
				insert(b->x+1, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+2, b->y+2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-4, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-4, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-4, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+3, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+3, b->y+1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+3, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+4, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+4, b->y+1, b->id, 0, 868, 450, NULL, b, img->s->ship1_250cm_wood_triangle);
				insert(b->x+3, b->y+2, b->id, 0, 868, 450, NULL, b, img->s->ship1_250cm_wood_triangle);
				insert(b->x-4, b->y-2, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood_down_triangle);
				insert(b->x+4, b->y-1, b->id, 0, 851, 372, NULL, b, img->s->ship1_flat_wood_left_triangle);
				insert(b->x+3, b->y-2, b->id, 0, 851, 372, NULL, b, img->s->ship1_flat_wood_left_triangle);
				insert(b->x-4, b->y+2, b->id, 0, 885, 372, NULL, b, img->s->ship1_flat_wood_right_triangle);
				insert(b->x-4, b->y+1, b->id, 0, 915, 355, NULL, b, img->s->ship1_bigSail);
				insert(b->x+1, b->y+1, b->id, 0, 915, 355, NULL, b, img->s->ship1_bigSail);
			}
			else if (b->angle =='k')
			{
				insert(b->x+3, b->y-2, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				...
				insert(b->x+4, b->y-1, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x-4, b->y, b->id, 0, 868, 466, NULL, b, img->s->ship1_250cm_wood);
				insert(b->x+4, b->y+2, b->id, 0, 868, 450, NULL, b, img->s->ship1_250cm_wood_triangle);
				insert(b->x-4, b->y-1, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood_down_triangle);
				insert(b->x-3, b->y-2, b->id, 0, 868, 372, NULL, b, img->s->ship1_flat_wood_down_triangle);
				insert(b->x+4, b->y-2, b->id, 0, 851, 372, NULL, b, img->s->ship1_flat_wood_left_triangle);
				insert(b->x-4, b->y+1, b->id, 0, 885, 372, NULL, b, img->s->ship1_flat_wood_right_triangle);
				insert(b->x-3, b->y+2, b->id, 0, 885, 372, NULL, b, img->s->ship1_flat_wood_right_triangle);
				insert(b->x+2, b->y+1, b->id, 0, 915, 355, NULL, b, img->s->ship1_bigSail);
				insert(b->x-3, b->y+1, b->id, 0, 915, 355, NULL, b, img->s->ship1_bigSail);
			}
		}
	}
}

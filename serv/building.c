    ...
    {     
        if (parcour->a_bouger != 0)
        {
            ...
            { 
                ...
                {
                    building_id[(int)(parcour->y-1) * max_x + (int)(parcour->x-6)] = -1;
                    building_id[(int)(parcour->y) * max_x + (int)(parcour->x-6)] = -1;
                    building_id[(int)(parcour->y+1) * max_x + (int)(parcour->x-6)] = -1;
                    building_id[(int)(parcour->y-2) * max_x + (int)(parcour->x-5)] = -1;
                    building_id[(int)(parcour->y+2) * max_x + (int)(parcour->x-5)] = -1;

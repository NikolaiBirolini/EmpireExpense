...
jfiles=jeu/graphic_widget/pictureButton.c jeu/graphic_widget/textInfo.c jeu/graphic_widget/textBox.c jeu/graphic_widget/button.c jeu/display.c jeu/arg_parse.c jeu/net.c jeu/gui.c jeu/perso.c jeu/init_sprite.c jeu/select_sprite.c jeu/clavier.c jeu/control.c jeu/parseur.c jeu/ordre.c jeu/ia.c jeu/map.c jeu/linked_char.c jeu/stat.c jeu/chiffrement.c jeu/inventaire.c jeu/diplo.c jeu/pathfinding.c jeu/init_sound.c jeu/btree.c jeu/shared_var.c jeu/collision.c
